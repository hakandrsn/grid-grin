...
- Bütün logları temizle
- memo, useMemo ve useCallback ile iyileştirilecek her yeri iyileştir
- listener, timeout ve event olarlarının her birinin kullanım sonrası temizlendiğinden emin ol.
- Kullanılmayan componentleri kaldır.
- Kullanılmayan methodları, utils dosyalarını kaldır.
